...
<body>
   <?php
    ...
    // PHP코드는 서버에서만 해석되는 프로그래밍 언어다!! 그래서 서버 사이드 스크립트라고 부른다!!! 반면 JS는 클라이언트 사이트 스크립트라고 한다!!!
    
    echo "<h1>echo를 사용한 변수 출력</h1>";
    ...
    $tit = ["헤드라인 뉴스","정치뉴스","연예뉴스"];
    $news1 = ['정의용 "한반도 비핵화는 한미 공동목표…조율 문제 없을 것"(종합)',
              '허경영 “나경원이 나경영? 9년간 1억은 푼돈… 난 일시불로 1억”',
             '이윤지, 故박지선 추억하며…"후유증 남아" 눈물'];
    $news2 = ["'일론 머스크' 한 마디에...비트코인 5천만원 돌파도 눈앞",
             "文정부 '블랙리스트 적폐' 첫 구속…김은경 징역 2년6개월",
             "'유 퀴즈' 출연한 7급 공무원 사망설"];
    
    /*
    위에 데이터를 DB에서 가져와 셋팅했다고 가정하자!!
    출력위치에 아래와 같이 코딩해준다
   ...
   ?>
    <div class="main_component droppable" id="today_main_news" style="width:727px">
            <div class="com_header">
               <!--1. 제목출력-->
                <h4 class="tit_h4 tit_main1"><strong><?=$tit[$rdn]?></strong></h4>
                <!--2. 안내문구 중 일부 출력-->
