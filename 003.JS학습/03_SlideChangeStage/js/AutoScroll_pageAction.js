...
$(function () { ///// jQB /////////////////
    ...
    init = function () {
        ...
        // 3. 인천상륙작전 : 위쪽으로 올라가있음 (내려올예정)
        $('#pg3 .minfo').css({
            top:'-50%'
        })
        
        // 4. 봉이 김선달 : 중앙에서 스케일 0으로함!!! (원래크기로 변경)
        // 주의사항 : transform은 animate로 할수 없다!!!
        // 이경우에는 tranistion으로 애니메이션 적용한다!!!
        // 유의사항 : 이미 transform으로 translate(-50%,-50%)가 적용되었으므로 sale(0)에 같이 써줘야한다!!!
        $("#pg4 .minfo").css({
            transform: "translate(-50%,-50%) scale(0)"
        });///// css ////////////
        
        // 5. 비밀은 없다 : y축으로 180도 뒤집어 놓고 투명하게 (원래각도로 뒤집으며 투명도 1로 보이게 애니메이션 예정)
        $('#pg5 .minfo').css({
            transform: "translate(-50%,-50%) rotateY(720deg)",
            opacity: '0'
        })///// css /////
        
        // 6. 아가씨 : 중앙에서 스케일0, 평면회전시켜 놓는다!!!
        // 원래크기와 각도로 애니메이션 복귀!!!
        $('#pg6 .minfo').css({
            transform: "translate(-50%,-50%) scale(0) rotate(1000deg)",
        })///// css /////
        
        // 7. 탐정홍길동 : x축 스케일 늘려놓는다. 투명도 0
        // (원래 크기와 투명도로 복귀예정)
        $('#pg7 .minfo').css({
    ...
    pageAction = function () {
        ...
        // transform 애니메이션은 transition으로 해야된다~!!!
        }///// else if /////
        ...
        $('#pg6 .minfo').css({
            ...
            transition:'all 2s cubic-bezier(1, 0.54, 0.18, 1.6)'
        })///// css /////
        }///// else /////
        ...
        // 7. 탐정홍길동
            ...
            opacity: '1',
            transition:'all 2s cubic-bezier(1, 0.18, 0, 1.14)'
        })///// css /////
        }///// else if /////
