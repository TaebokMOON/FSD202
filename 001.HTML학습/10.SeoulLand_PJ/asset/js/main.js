...
$(function(){ /// jQB ///////////////////////////
    ...
    $(".tabTit a").click(function(e){
        ...
        // 2. 탭메뉴는 클릭된 자신(this)의 부모(li)에게 class="on" 다른 형제 요소들(li)은 
        // class="on" 을 지운다
    ...
    // chamge 이벤트 대상: #fslink
    // 변경대상 : 새창열고 사이트 이동하기
    // 선택박스의 선택을 변경할떄 발생하는 이벤트 : change
    ...
    $('#fslink').change(function(){
        ...
        switch(opt){
                ...
                case'cal': url='http://www.irosehill.co.kr/';break;
                case'rose':url='http://www.icpk.co.kr/';break;
