...
// 개발시에 창사이즈 변경하면 이를 변경함
// resize()메서드 - 선택여소의 창크기변경시 실행
...
function pageAction() {
    ...
    if(pno === 3 && pg4sts === 0){
        ...
        $('.txts>li').each(function(idx,ele){
            ...
            // delay(순번*100) -> 시간이 0,100,200,300,400....순으로 셋팅
            $(ele).delay(idx*100).animate({
                top:'0',
                left:'0',
                opacity: 1,
            },400,"easeInExpo")///// animate /////
